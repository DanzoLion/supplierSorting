...
df1.rename(columns= {"Express Sku": "SKU", "PriceExpress":"Price", "Production Days Express":"Turnaround"}, inplace=True)
...
dropCol = tpAppended.drop('Unnamed: 0', axis=1)
dropCol.reset_index(drop=True)


print(dropCol.head(3))

dropCol.to_csv("TPjoinedTable.csv")
