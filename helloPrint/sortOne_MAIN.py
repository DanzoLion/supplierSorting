...
# route1 = df[0].str.split(',', expand=True)
#route1 = pd.read_csv(csvFileName, error_bad_lines=False, engine="python")                                                                                     # READ FILE
print(f'\r')
...
dataframe = pd.DataFrame(df, columns = [                                                                                                                                             # WANTED COLUMNS
'sku',                                                                                                            
'quantity', 
'servicelevel',
'productiondays',
...
df = pd.read_csv(f"B:\\pythonPrintCompare\\sortJoin\\{sortedName}" + "~SortTwo_.csv")    
